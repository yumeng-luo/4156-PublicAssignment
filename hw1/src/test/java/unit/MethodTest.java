...
public class MethodTest {
  ...
  public void testSendGB() {
    ...
    Gson gson = new Gson();
    PlayGame.sendGameBoardToAllPlayers(gson.toJson(PlayGame.getGb()));
  ...
  public void testCheckMove_valid_p1() {
    ...
    PlayGame.getGb().setBoardState(new char[3][3]);
  ...
  public void testCheckGameEndTrue() {
    ...
    PlayGame.getGb().setBoardState(boardState2);
    gameEnd = PlayGame.checkGameEnd();
    assertEquals(true, gameEnd);

    char[][] boardState3 = { { 'X', '\0', 'O' }, { 'X', '\0', 'O' }, { '\0', '\0', 'O' } };
    PlayGame.getGb().setBoardState(boardState3);
    gameEnd = PlayGame.checkGameEnd();
    assertEquals(true, gameEnd);

    char[][] boardState4 = { { 'O', 'O', 'O' }, { '\0', '\0', '\0' }, { 'X', 'X', '\0' } };
    PlayGame.getGb().setBoardState(boardState4);
    gameEnd = PlayGame.checkGameEnd();
    assertEquals(true, gameEnd);

    char[][] boardState5 = { { 'X', 'X', '\0' }, { 'O', 'O', 'O' }, { '\0', '\0', '\0' } };
    PlayGame.getGb().setBoardState(boardState5);
    gameEnd = PlayGame.checkGameEnd();
    assertEquals(true, gameEnd);

    char[][] boardState6 = { { '\0', '\0', '\0' }, { 'X', 'X', '\0' }, { 'O', 'O', 'O' } };
    PlayGame.getGb().setBoardState(boardState6);
    gameEnd = PlayGame.checkGameEnd();
    assertEquals(true, gameEnd);

    char[][] boardState7 = { { 'O', '\0', '\0' }, { 'X', 'O', '\0' }, { 'X', '\0', 'O' } };
    PlayGame.getGb().setBoardState(boardState7);
    gameEnd = PlayGame.checkGameEnd();
    assertEquals(true, gameEnd);

    char[][] boardState8 = { { '\0', '\0', 'O' }, { 'X', 'O', '\0' }, { 'O', '\0', 'X' } };
    PlayGame.getGb().setBoardState(boardState8);
    gameEnd = PlayGame.checkGameEnd();
    assertEquals(true, gameEnd);

    char[][] boardState9 = { { '\0', '\0', 'O' }, { 'X', '\0', '\0' }, { 'O', '\0', 'O' } };
    PlayGame.getGb().setBoardState(boardState9);
    gameEnd = PlayGame.checkGameEnd();
    assertEquals(false, gameEnd);

    char[][] boardState10 = { { '\0', '\0', 'O' }, { 'X', '\0', '\0' }, { 'O', 'X', 'O' } };
    PlayGame.getGb().setBoardState(boardState10);
    gameEnd = PlayGame.checkGameEnd();
    assertEquals(false, gameEnd);
